<div align="center">
  <br />
    <a href="https://sociomax.netlify.app" target="_blank">
      <img src="./public/assets/socioMax1.png" alt="Project Banner">
    </a>
  <br />
...
```bash
git clone https://github.com/anantiikenna/socio_max.git
cd socio_max
```
